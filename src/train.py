...
from src.n2n_dialogue_system import gen_tracker_model_and_loss
...
def main():
    ...
    def train(ep):
        ...
        states_gt = { slot : Variable(v) for slot, v in states_gt.items() }
    ...
    def validate(ep):
        ...
        while True:
            try:
                utts, _, usr_utts, _, states_gt, kb_found, sys_utt_grp_gt = vloader.next()
            except:
                break
